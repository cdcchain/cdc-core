...
static_assert((int)cdcchain::network::block_message_type == (int)cdcchain::client::block_message_type, "enum values don't match");
static_assert((int)cdcchain::network::trx_message_type == (int)cdcchain::client::trx_message_type, "enum values don't match");
