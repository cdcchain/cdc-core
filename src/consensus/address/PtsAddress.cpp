...
namespace fc
{
    void to_variant(const cdcchain::consensus::PtsAddress& var, variant& vo)
    {
        vo = std::string(var);
    }
    void from_variant(const variant& var, cdcchain::consensus::PtsAddress& vo)
    {
        vo = cdcchain::consensus::PtsAddress(var.as_string());
    }
}
