...
FC_REFLECT(cdcchain::consensus::PublicKeyType, (key_data))
FC_REFLECT(cdcchain::consensus::PublicKeyType::BinaryKey, (data)(check));
FC_REFLECT_ENUM(cdcchain::consensus::BlockchainSecurityState::alert_level_enum, (green)(yellow)(red)(grey));
FC_REFLECT(cdcchain::consensus::BlockchainSecurityState, (alert_level)(estimated_confirmation_seconds)(participation_rate))
