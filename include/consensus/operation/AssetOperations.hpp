...
FC_REFLECT(cdcchain::consensus::CreateAssetOperation,
    (symbol)
    (name)
    (description)
    (public_data)
    ...
    FC_REFLECT(cdcchain::consensus::UpdateAssetOperation,
    (asset_id)
    (name)
    (description)
    (public_data)
    ...
    FC_REFLECT_DERIVED(cdcchain::consensus::UpdateAssetExtOperation,
    (cdcchain::consensus::UpdateAssetOperation),
    (flags)
    (issuer_permissions)
    (issuer_account_id)
    (transaction_fee)
    ...
    FC_REFLECT(cdcchain::consensus::IssueAssetOperation,
    (amount)
    )
