...
namespace cdcchain {
    namespace consensus {
        ...
        struct Price
        {
            ...
            fc::uint128_t ratio; // This is a DECIMAL FRACTION with denominator equal to CDC_PRICE_PRECISIONI
...
FC_REFLECT(cdcchain::consensus::Price, (ratio)(quote_asset_id)(base_asset_id));
FC_REFLECT(cdcchain::consensus::Asset, (amount)(asset_id));
