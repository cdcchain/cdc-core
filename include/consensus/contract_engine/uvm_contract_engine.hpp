...
namespace glua
{
	using namespace cdcchain;

	class UvmContractEngine : public cdcchain::consensus::contract_engine::ContractEngine
	{
	private:
	...
	public:
		...
		virtual std::shared_ptr<::cdcchain::consensus::contract_engine::VMModuleByteStream> get_bytestream_from_code(const uvm::blockchain::Code& code);
	};
}
