    ...
    namespace consensus {
        ...
        public:
            ...
            */
            ...
            /**
            * Get time of genesis(registion of Asset CDC)
            *
            ...
            */
			...
			oProposalEntry                    get_proposal_entry(const ProposalIdType& id) const;

			void                              remove_proposal_entry(const ProposalIdType& id);
