...
FC_REFLECT(cdcchain::consensus::ExtendedPublicKey, (pub_key)(chain_code))
FC_REFLECT(cdcchain::consensus::ExtendedPrivateKey, (priv_key)(chain_code))
FC_REFLECT(cdcchain::consensus::ExtendedAddress, (addr))

namespace fc
{
    void to_variant(const cdcchain::consensus::ExtendedAddress& var, fc::variant& vo);
    void from_variant(const fc::variant& var, cdcchain::consensus::ExtendedAddress& vo);
}

namespace std
{
    template<>
    struct hash < cdcchain::consensus::ExtendedAddress >
    {
    public:
        size_t operator()(const cdcchain::consensus::ExtendedAddress &a) const
        {
            size_t s;
            fc::sha1::encoder enc;
            fc::raw::pack(enc, a);
