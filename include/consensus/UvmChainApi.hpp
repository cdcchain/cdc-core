		...
		namespace api
		{
			...
			public:
				...
				*/
				...
				virtual std::vector<std::string> get_mining_pool_admin(lua_State *L);
				virtual std::vector<std::string> get_statistics_pool_admin(lua_State *L);
				virtual std::vector<std::string> get_merchant_admin(lua_State *L);
				virtual std::vector<std::string> get_arbitrament_admin(lua_State *L);

				virtual std::vector<std::string> get_mining_pool_operator(lua_State *L);
				virtual std::vector<std::string> get_statistics_pool_operator(lua_State *L);
				virtual std::vector<std::string> get_merchant_operator(lua_State *L);
				virtual std::vector<std::string> get_arbitrament_operator(lua_State *L);

				// verify
				virtual int32_t verify_privilege_admin(lua_State *L, const char* verify_address);
				virtual int32_t verify_general_admin(lua_State *L, const char* verify_address);

				virtual int32_t verify_mining_pool_admin(lua_State *L, const char* verify_address);
				virtual int32_t verify_statistics_pool_admin(lua_State *L, const char* verify_address);
				virtual int32_t verify_merchant_admin(lua_State *L, const char* verify_address);
				virtual int32_t verify_arbitrament_admin(lua_State *L, const char* verify_address);

				virtual int32_t verify_mining_pool_operator(lua_State *L, const char* verify_address);
				virtual int32_t verify_statistics_pool_operator(lua_State *L, const char* verify_address);
				virtual int32_t verify_merchant_operator(lua_State *L, const char* verify_address);
				virtual int32_t verify_arbitrament_operator(lua_State *L, const char* verify_address);

				// appoint
				virtual int32_t appoint_mining_pool_admin(lua_State *L, const char* pool_admin);
				virtual int32_t appoint_statistics_pool_admin(lua_State *L, const char* pool_admin);
				virtual int32_t appoint_merchant_admin(lua_State *L, const char* merchant_admin);
				virtual int32_t appoint_arbitrament_admin(lua_State *L, const char* arbitrament_admin);

				virtual int32_t appoint_mining_pool_operator(lua_State *L, const char* pool_operator);
				virtual int32_t appoint_statistics_pool_operator(lua_State *L, const char* pool_operator);
				virtual int32_t appoint_merchant_operator(lua_State *L, const char* merchant_operator);
				virtual int32_t appoint_arbitrament_operator(lua_State *L, const char* arbitrament_operator);

				// revoke
				virtual int32_t revoke_mining_pool_admin(lua_State *L, const char* pool_admin);
				virtual int32_t revoke_statistics_pool_admin(lua_State *L, const char* pool_admin);
				virtual int32_t revoke_merchant_admin(lua_State *L, const char* merchant_admin);
				virtual int32_t revoke_arbitrament_admin(lua_State *L, const char* arbitrament_admin);

				virtual int32_t revoke_mining_pool_operator(lua_State *L, const char* pool_operator);
				virtual int32_t revoke_statistics_pool_operator(lua_State *L, const char* pool_operator);
				virtual int32_t revoke_merchant_operator(lua_State *L, const char* merchant_operator);
				virtual int32_t revoke_arbitrament_operator(lua_State *L, const char* arbitrament_operator);

				// for CDC data
				// checkin
				virtual int32_t checkin_user_receipt_hash(lua_State *L, const char* user_receipt_hash);
				virtual int32_t checkin_mining_result_hash(lua_State *L, const char* mining_result_hash);
				virtual int32_t checkin_ad_putting_feedback_hash(lua_State *L, const char* ad_putting_feedback_hash);
				virtual int32_t checkin_ad_putting_result_hash(lua_State *L, const char* ad_putting_result_hash);

				// verify
				virtual int32_t verify_user_receipt_hash(lua_State *L, const char* user_receipt_hash);
				virtual int32_t verify_mining_result_hash(lua_State *L, const char* mining_result_hash);
				virtual int32_t verify_ad_putting_feedback_hash(lua_State *L, const char* ad_putting_feedback_hash);
				virtual int32_t verify_ad_putting_result_hash(lua_State *L, const char* ad_putting_result_hash);

				// abolish
				virtual int32_t abolish_user_receipt_hash(lua_State *L, const char* user_receipt_hash);
				virtual int32_t abolish_mining_result_hash(lua_State *L, const char* mining_result_hash);
				virtual int32_t abolish_ad_putting_feedback_hash(lua_State *L, const char* ad_putting_feedback_hash);
				virtual int32_t abolish_ad_putting_result_hash(lua_State *L, const char* ad_putting_result_hash);
			};
