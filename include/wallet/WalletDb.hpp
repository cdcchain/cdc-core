...
namespace cdcchain {
    namespace wallet {
        ...
        public:
            ...
            void                   store_account(const cdcchain::consensus::AccountEntry& blockchain_account_entry, fc::sha512 password = fc::sha512());
        ...
        private:
            ...
            unordered_map<Address, Address>                                btc_to_cdc_address;
