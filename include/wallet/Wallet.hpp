...
#define INVALIDE_SCDC_ADDRESS ("ffffffffffffffffffffffffffffffff")
namespace cdcchain {
    namespace wallet {
        ...
        public:
            ...
            */
            ...
            void					set_last_scanned_block_number_for_cdc(uint32_t block_num);
            /**
            ...
            */
            ...
            uint32_t				get_last_scanned_block_number_for_cdc()const;
           ...
           */
            ...
            * @param scdc_account the address which only used in centralized services
            *
            * @return void
            */
            static void accountsplit(const string & original, string & to_account, string & scdc_account);
            /**
            ...
            * @param amount_to_transfer_symbol the asset to transfer like CDC 
            ...
            * @param cdc_account centralized system address
            *
            * @return WalletTransactionEntry
            */
			...
			std::vector<cdcchain::consensus::Asset> contract_upgrade_testing(
				const Address& contract_id,
				const string& upgrader_name,
				const string& contract_name,
				const string& contract_desc,
			...
			std::vector<cdcchain::consensus::Asset> contract_destroy_testing(
				const Address& contract_id,
				const string& destroyer_name,
				bool sign = true
				);
            ...
            */
            WalletTransactionEntry register_account(
                ...
                cdcchain::consensus::AccountType new_account_type,
                bool sign
                );
            /**
            ...
            */
            DelegatePaySalary query_delegate_salary(
                const string& delegate_name);
            std::map<std::string, cdcchain::consensus::DelegatePaySalary> query_delegate_salarys();
            ...
            * @return string
            */
            PrettyTransaction				    to_pretty_trx(const cdcchain::consensus::TransactionEntry& trx_entry, const std::string addr_for_fee) const;


            PrettyContractTransaction           to_pretty_contract_trx(const cdcchain::consensus::TransactionEntry& trx_entry) const;
...
FC_REFLECT_ENUM(cdcchain::wallet::AccountKeyType,
    (owner_key)
    (active_key)
    (signing_key)
    )
