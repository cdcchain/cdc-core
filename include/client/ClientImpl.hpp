...
namespace cdcchain {
    namespace client {
        ...
        namespace detail {
            ...
            {
            public:
                typedef cdcchain::db::LevelMap<fc::time_point, fc::exception> ExceptionLeveldbType;
            private:
            ...
            public:
                void open(const fc::path& filename)
                {
                    ...
                    catch (const cdcchain::db::level_map_open_failure&)
                    {
            ...
            class ClientImpl : public cdcchain::network::NodeDelegate,
                public cdcchain::api::CommonApi
            {
            public:
                ...
                ClientImpl(cdcchain::client::Client* self, const std::string& user_agent) :
                    _self(self),
                    ...
                    _blockchain_synopsis_size_limit((unsigned)(log2(CDC_BLOCKCHAIN_BLOCKS_PER_YEAR * 20))),
                    _debug_last_wait_block(0)
                {
                    try
                    {
                        if (uvm::lua::api::global_uvm_chain_api == nullptr)
                            uvm::lua::api::global_uvm_chain_api = new cdcchain::lua::api::UvmChainApi;
                ...
                */
				...
				cdcchain::consensus::TransactionIdType network_broadcast_transactions(const std::vector<cdcchain::consensus::SignedTransaction>& transactions_to_broadcast);
                ...
                // @{
				virtual bool has_item(const cdcchain::network::ItemId& id) override;
				fc::time_point_sec handle_ntp_time(bool need_update)override;
                virtual bool handle_message(const cdcchain::network::Message&, bool sync_mode) override;
                virtual std::vector<cdcchain::network::ItemHashType> get_item_ids(uint32_t item_type,
                    const vector<cdcchain::network::ItemHashType>& blockchain_synopsis,
                    uint32_t& remaining_item_count,
                    uint32_t limit = 2000) override;
                virtual cdcchain::network::Message get_item(const cdcchain::network::ItemId& id) override;
                virtual fc::sha256 get_chain_id() const override
                {
                    FC_ASSERT(_chain_db != nullptr);
                    return _chain_db->get_chain_id();
                }
                virtual std::vector<cdcchain::network::ItemHashType> get_blockchain_synopsis(uint32_t item_type,
                ...
                virtual uint32_t get_block_number(const cdcchain::network::ItemHashType& block_id) override;
                virtual fc::time_point_sec get_block_time(const cdcchain::network::ItemHashType& block_id) override;
                virtual fc::time_point_sec get_blockchain_now() override;
                virtual cdcchain::network::ItemHashType get_head_block_id() const override;
                ...
                cdcchain::client::Client*                                    _self;
                std::string                                             _user_agent;
                cdcchain::console::Cli*                                          _cli = nullptr;
                ...
                cdcchain::rpc::RpcServerPtr                                _rpc_server = nullptr;
                //std::unique_ptr<cdcchain::network::ChainServer>                 _chain_server = nullptr;
                std::unique_ptr<cdcchain::network::UpnpService>                 _upnp_service = nullptr;
                ...
                //  std::shared_ptr<cdcchain::mail::server>                      _mail_server = nullptr;
                // std::shared_ptr<cdcchain::mail::client>                      _mail_client = nullptr;
                ...
                cdcchain::network::NodePtr                                      _p2p_node = nullptr;
                bool                                                    _simulated_network = false;

                UbGntpNotifierPtr                                   _notifier;
                ...
                // include all of the method overrides generated by the cdc_api_generator
